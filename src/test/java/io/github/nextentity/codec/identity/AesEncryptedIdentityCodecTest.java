...
public class AesEncryptedIdentityCodecTest {
    ...
    void testGetComponentAccess() {
        assertNotNull(encryptedCodec.getCodec(), "应该能够获取 IdentityCodec");
        assertNotNull(encryptedCodec.getEncryptor(), "应该能够获取 XorEncryptor");
    }
    ...
    void testCompatibilityWithSimpleCodec() {
        ...
        // 手动加密
        long manualEncrypted = encryptedCodec.getEncryptor().encrypt(plainEncoded);
